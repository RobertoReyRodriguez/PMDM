...
public class ThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main); // Usa el mismo layout
        ...
        tvCurrentScreen.setText("Pantalla actual: 3");
    ...
    private void configureNavigationButtons() {
        ...
        btnToScreen1.setOnClickListener(view -> navigateToScreen(MainActivity.class, 3));
        btnToScreen2.setOnClickListener(view -> navigateToScreen(SecondActivity.class, 3));
        btnToScreen3.setOnClickListener(view -> navigateToScreen(ThirdActivity.class, 3));
    }

    private void navigateToScreen(Class<?> targetActivity, int currentScreen) {
        // Cambiar la referencia a ThirdActivity.this
