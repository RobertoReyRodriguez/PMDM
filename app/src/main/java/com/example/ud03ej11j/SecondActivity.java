...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCurrentScreen.setText("Pantalla actual: 2");
    ...
    private void configureNavigationButtons() {
        ...
        btnToScreen1.setOnClickListener(view -> navigateToScreen(MainActivity.class, 2));
        btnToScreen2.setOnClickListener(view -> navigateToScreen(SecondActivity.class, 2));
        btnToScreen3.setOnClickListener(view -> navigateToScreen(ThirdActivity.class, 2));
    }
